...
pub fn encrypt_large_file(filepath: &str, dist: &str, key: &[u8; 32], nonce: &[u8; 24]) -> Result<(), anyhow::Error>{
...
pub fn decrypt_large_file(encrypted_file_path: &str,dist: &str,key: &[u8; 32],nonce: &[u8; 24]) -> Result<(), anyhow::Error>{
    let aead = XChaCha20Poly1305::new(key.as_ref().into());
